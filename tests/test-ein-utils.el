...
(ert-deftest ein-url-parse-no-path-good ()
  (should (equal (ein:parse-url-no-path "pr://1.2.3.4:80")
                 (make-ein:url :protocol "pr" :host "1.2.3.4" :port "80")))
  (should (equal (ein:parse-url-no-path "pr://1.2.3.4")
                 (make-ein:url :protocol "pr" :host "1.2.3.4")))
  (should (equal (ein:parse-url-no-path "pr://localhost")
                 (make-ein:url :protocol "pr" :host "localhost")))
  (should (equal (ein:parse-url-no-path "1.2.3.4:80")
                 (make-ein:url :protocol "http" :host "1.2.3.4" :port "80")))
  (should (equal (ein:parse-url-no-path "1.2.3.4")
                 (make-ein:url :protocol "http" :host "1.2.3.4")))
  (should (equal (ein:parse-url-no-path "1234")
                 (make-ein:url :protocol "http" :host "127.0.0.1" :port "1234"))))

(ert-deftest ein-url-parse-no-path-bad ()
  (should-error (ein-parse-url-no-path ""))
  (should-error (ein-parse-url-no-path ":"))
  (should-error (ein-parse-url-no-path "pr://"))
  (should-error (ein-parse-url-no-path "pr://80")))
